...
: Properties of \\(A\\) imply properties of its eigenvalues:
  ...
  {% include figure.html alt="Eigenvalues on the unit circle with half-integer real part" src="half-integers.png" %}
...
{% include figure.html alt="X-rays bouncing off an atom" src="scattering.png" %}
...
{% include demolink.md thumb="/quasi/thumb-waves.jpg" text="Sums of waves" url="/quasi/waves.html" %}
...
{% include demolink.md thumb="/quasi/thumb-2d.png" text="2-D quasicrystals" url="/quasi/2d.html" %}
...
\\(G \\subset \\operatorname{SL}(m,\\mathbb{Z})\\).
...
{% include demolink.md thumb="/quasi/thumb-3d.png" text="3-D quasicrystals" url="/quasi/3d.html" %}
